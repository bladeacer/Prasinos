            ...
            http.post('/file/upload', formData, {
                ...
                .catch(function (error) {
                    if (error.response) {
                        ...
                        toast.error(`Upload failed: ${error.response.data.message || error.response.data}`);
                        ...
                        <>
                            ...
                            <Box component="form" onSubmit={formik.handleSubmit}>
                                ...
                                <Typography variant='h6' sx={{ mt: 1 }}>Upload profile picture</Typography>
                                {
                                    imageFile && (
                                        <Box sx={{ mt: 3}}>
                                            <img alt="image" className="smallImage"
                                                src={`${import.meta.env.VITE_FILE_BASE_URL}${imageFile}`} sx={{ zIndex: 10, scale: '45%' }}>
                                            </img>
                                        </Box>
                                    )
                                }
                                <Button variant="contained" component="label" sx={{ my: 4, ml: 22, mt: -7.5 }}>
                                    Upload Image
