...
function Register() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (data) => {
            console.log("Form submitted", data); // Debugging statement
            data.name = data.name.trim();
            data.email = data.email.trim().toLowerCase();
            data.password = data.password.trim();
            data.phoneNumber = data.phoneNumber;
            console.log("Data before API call", data); // Debugging statement
            http.post("/user/register", data)
                .then((res) => {
                    console.log("API call successful", res); // Debugging statement
                    window.location.href = "/login";
                })
                .catch(function (err) {
                    console.log("API call error", err); // Debugging statement
